    ...
    try {
      ...
      if (authError) {
        if (authError.message.includes("provider is not enabled")) {
          throw new Error(
            "Google Login is not enabled. Please use email/password for the collective.",
          );
        }
        throw authError;
      }
    ...
    <div className="max-w-md mx-auto px-4 py-24 animate-in fade-in duration-1000">
      <div className="text-center mb-12">
        ...
        <p className="text-sm text-gray-400 font-light">
          {mode === "login"
            ...
            : mode === "signup"
              ? "Create an account to manage your curations"
      ...
      <div className="space-y-8">
        ...
        <div className="relative flex items-center py-4">
          ...
          <span className="flex-shrink mx-6 text-[8px] text-gray-300 uppercase font-bold tracking-[0.5em]">
            OR
          </span>
          <div className="flex-grow border-t border-gray-100"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {mode === "signup" && (
            <div className="group">
              <label className="block text-[10px] font-bold uppercase tracking-widest text-vogue-500 mb-2">
                Full Name
              </label>
              <input
                type="text"
          ...
          {mode !== "forgot-password" && (
            <div className="group relative">
              ...
              <div className="relative">
                ...
                >
                  <i
                    className={`fa-solid ${showPassword ? "fa-eye-slash" : "fa-eye"} text-xs`}
                  ></i>
                </button>
              </div>
            </div>
        ...
        {mode === "login" ? (
          <p className="text-xs text-gray-500 font-light">
            ...
            <button
              ...
              className="font-bold text-black border-b border-black pb-0.5 hover:text-vogue-500 transition-colors"
            >
