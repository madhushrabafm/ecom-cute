                ...
                <div className="grid grid-cols-4 gap-2">
                  {product.sizes.map((size) => (
                    <button
                      ...
                      className={`py-3 text-[10px] font-bold border transition-all ${selectedSize === size ? "bg-black text-white border-black shadow-lg" : "hover:border-black text-gray-400"}`}
                    >
                      {size}
                    </button>
                  ))}
            ...
            <div className="pt-8 border-t border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-grow flex items-center justify-center gap-2 py-2.5 text-[10px] font-bold uppercase tracking-widest border transition-all ${copySuccess ? "bg-black text-white border-black" : "bg-white text-black border-gray-100 hover:border-black"}`}
                >
