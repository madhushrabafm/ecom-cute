    ...
    setTimeout(() => {
      setTrackingData({
        ...
        steps: [
          ...
          {
            label: "Handpicked & Quality Checked",
            date: "Oct 12, 02:45 PM",
            completed: true,
          },
          {
            label: "Shipped from Hub",
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-12 py-24 animate-in fade-in duration-1000">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-24 space-y-4">
          <span className="text-vogue-500 text-[10px] font-bold uppercase tracking-[0.5em] block">
            Logistics Dashboard
          </span>
          ...
          <p className="text-gray-400 font-light max-w-lg mx-auto leading-relaxed">
            Monitor the journey of your curated pieces from our heritage
        ...
        {!trackingData ? (
          <div className="relative group">
            ...
            <div className="bg-white border border-gray-100 p-12 lg:p-20 rounded-sm shadow-sm">
              ...
              >
                <div className="group">
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-vogue-500 mb-3 transition-colors group-focus-within:text-black">
                    Order Identifier
                  </label>
                  <input
                    required
              ...
              <div className="mt-12 flex items-center justify-center gap-6 text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                ...
                <span className="w-1 h-1 bg-gray-200 rounded-full"></span>
                <span>Luna Decor Concierge Linked</span>
              </div>
            </div>
          </div>
        ) : (
          <div className="space-y-12 animate-in slide-up">
            <div className="grid grid-cols-1 lg:grid-cols-3 bg-zinc-950 text-white rounded-sm overflow-hidden shadow-2xl">
              <div className="p-12 border-b lg:border-b-0 lg:border-r border-white/5">
                <p className="text-[10px] font-bold uppercase text-white/30 mb-4 tracking-widest">
                  Current Phase
                </p>
                <h3 className="text-4xl font-serif font-bold italic text-white tracking-tighter">
                  {trackingData.status}
                </h3>
              ...
              <div className="p-12 flex flex-col justify-between">
                ...
                <Link
                  to="/contact"
                  className="text-[9px] font-bold uppercase tracking-widest text-vogue-500 hover:text-white transition-colors flex items-center gap-2 mt-8"
                >
              ...
              <div className="relative">
                ...
                <div className="space-y-24">
                  {trackingData.steps.map((step: any, idx: number) => (
                    <div
                      key={idx}
                      className={`relative flex flex-col md:flex-row items-start md:items-center gap-12 md:gap-0 ${idx % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}
                    >
                      {/* Desktop Label Side */}
                      <div className="flex-1 hidden md:block text-right px-16">
                        {idx % 2 === 0 && (
                          <div className="space-y-1">
                            <h4
                              className={`text-[10px] font-bold uppercase tracking-widest ${step.completed ? "text-black" : "text-gray-300"}`}
                            >
                              {step.label}
                            </h4>
                            <p className="text-[9px] text-gray-400 uppercase font-light tracking-tighter">
                              {step.date}
                            </p>
                          </div>
                        )}
                      ...
                      {/* Dot */}
                      <div
                        className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center border-4 transition-all duration-1000 ${step.completed ? "bg-black border-black text-white shadow-xl" : "bg-white border-gray-100 text-gray-200"}`}
                      >
                        {step.completed ? (
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 pt-12">
              ...
              <Link
                to="/shop"
                className="text-[10px] font-bold uppercase tracking-widest bg-black text-white px-12 py-5 hover:bg-zinc-800 transition-all text-center"
              >
                Continue Shopping
              </Link>
            </div>
