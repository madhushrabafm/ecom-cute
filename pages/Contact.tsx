...
const Contact: React.FC = () => {
  ...
  const handleAiConcierge = async (topic: string) => {
    ...
    const response = await getFashionAdvice(
      `Act as the Luna Decor Customer Concierge. Help the user with: ${topic}. Be professional, luxury-oriented, and concise.`,
    );
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-12 py-24 animate-in fade-in duration-1000">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
        ...
        <div className="space-y-20">
          <header>
            <span className="text-vogue-500 text-[10px] font-bold uppercase tracking-[0.5em] mb-6 block">
              Concierge Services
            </span>
            <h1 className="text-6xl md:text-8xl font-serif font-bold tracking-tighter mb-8 leading-[0.8]">
              At Your <br /> Service.
            </h1>
            <p className="text-xl text-gray-400 font-light leading-relaxed max-w-md">
              Whether you require sizing guidance or have inquiries regarding a
              brand partner, our specialized concierge is available to assist
              you.
            </p>
          </header>
          ...
          <div className="bg-zinc-950 p-10 text-white rounded-sm shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-xs text-white/50 leading-relaxed font-light">
                Need instant answers about our styles or policies? Ask our
                intelligent assistant.
              </p>

              <div className="flex flex-wrap gap-2">
                {["Returns Policy", "Sizing Help", "Brand Authenticity"].map(
                  (topic) => (
                    <button
                      key={topic}
              ...
              {aiLoading && (
                <div className="text-xs text-white/50 animate-pulse italic">
                  Connecting with Concierge...
                </div>
              )}
              {aiResponse && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-10">
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-vogue-500 mb-4">
                Direct Concierge
              </h4>
          ...
          <div className="bg-white p-12 lg:p-16 border border-gray-100 rounded-sm shadow-sm h-full">
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-12">
                <div className="space-y-8">
                  <div className="group relative">
                    <label className="block text-[10px] font-bold uppercase tracking-widest text-vogue-500 mb-2 transition-all group-focus-within:text-black">
                      Subject of Inquiry
                    </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="group relative">
                      ...
                      <input
                        required
                        type="text"
                        className="w-full bg-transparent border-b border-gray-200 focus:border-black outline-none py-4 text-sm transition-all"
                  ...
                  <div className="group relative">
                    ...
                    <textarea
                      required
                      rows={6}
                      className="w-full bg-transparent border-b border-gray-200 focus:border-black outline-none py-4 text-sm transition-all resize-none"
                ...
                <button
                  type="submit"
                  className="group w-full bg-black text-white py-6 text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-zinc-900 transition-all flex items-center justify-center gap-4 active:scale-95"
                >
                  Send Inquiry
              ...
              <div className="h-full flex flex-col items-center justify-center text-center py-20 animate-in zoom-in-95">
                ...
                <h3 className="text-4xl font-serif font-bold italic tracking-tight mb-6">
                  Received with gratitude.
                </h3>
                <p className="text-gray-400 font-light leading-relaxed max-w-xs mx-auto mb-10">
                  Our concierge team has received your inquiry. We typically
                  respond within 12 business hours.
                </p>
                <button
                  onClick={() => setSubmitted(false)}
                  className="text-[10px] font-bold uppercase tracking-widest border-b border-black pb-2 hover:text-vogue-500 transition-colors"
                >
