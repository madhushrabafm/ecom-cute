      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:pl-10">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] mb-8 text-vogue-500">
              Concierge
            </h4>
          ...
          <div className="bg-white p-8 border border-gray-100 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] mb-4 text-vogue-500">
                The Luna DecorDigest
              </h4>
              <p className="text-[12px] text-gray-500 mb-6 leading-relaxed font-light">
                Be the first to know about exclusive archive launches and
                seasonal curations.
              </p>
              <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                ...
                />
                <button className="w-full bg-black text-white text-[10px] uppercase font-bold tracking-[0.3em] py-4 hover:bg-zinc-800 transition-all active:scale-95 shadow-lg">
                  Subscribe
                </button>
              </form>
            </div>
        ...
        <div className="border-t border-gray-200 pt-10 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-10">
            <p className="text-[9px] text-gray-400 uppercase tracking-widest">
              &copy; 2026 Luna Decor. KOLKATA , INDIA.
            </p>
