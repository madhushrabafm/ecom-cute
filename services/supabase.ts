 ...
 */
const supabaseUrl = process.env.SUPABASE_URL || 'https://qahreermniosjngxqsnm.supabase.co';
const supabaseAnonKey = process.env.SUPABASE_ANON_KEY || 'sb_publishable_Emv9qEIa9NapUI9gKW1uzA_WWUZZlSf';
